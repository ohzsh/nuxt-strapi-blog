...
<template>
  <main>
    <Header />
    <div class="w-1200px flex mx-auto my-5">
      <Sidebar />
      ...
      <section v-else class="w-full flex items-center h-full sm:p-16 dark:text-gray-100">
        <div class="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
          ...
          <p class="text-3xl">
            Looks like our network are currently offline
          </p>
        </div>
      </section>
    </div>
